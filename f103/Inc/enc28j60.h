...
extern void ENC28J60_PhyWrite(uint8_t address, uint16_t data);
extern void ENC28J60_ClkOut(uint8_t clk);
extern void enc28j60SpiInit(void);
extern void ENC28J60_Init(uint8_t* macaddr);
extern void ENC28J60_PacketSend(uint16_t len, uint8_t* packet);
extern uint16_t ENC28J60_PacketReceive(uint16_t maxlen, uint8_t* packet);
